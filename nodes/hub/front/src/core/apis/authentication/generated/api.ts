...
export const AuthenticationApiFp = function(configuration?: Configuration) {
	...
	return {
		...
		async loginInit(
			...
			axios?: AxiosInstance,
			basePath?: string,
		) => AxiosPromise<PostLoginModelWithSalt>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.loginInit(
				postLoginInitRequest,
				options,
			);
			return createRequestFunction(
		...
		async validToken(
			...
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.validToken(token, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
...
export const UsersApiAxiosParamCreator = function(
	...
	return {
		...
		getUserCredentials: async (
			...
			const localVarPath = `/api/users/{username}/credentials`.replace(
				`{${"username"}}`,
			...
			if (
				...
				localVarHeaderParameter["authentication_token"] =
		...
		getUserInfo: async (
			...
			const localVarPath = `/api/users/{kind}`.replace(
				`{${"kind"}}`,
		...
		getUserSettings: async (
			...
			const localVarPath = `/api/users/{username}/settings`.replace(
				`{${"username"}}`,
				encodeURIComponent(String(username)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		getUserTheme: async (
			...
			const localVarPath = `/api/users/{username}/settings/theme`.replace(
				`{${"username"}}`,
				encodeURIComponent(String(username)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const UsersApiFp = function(configuration?: Configuration) {
	...
	return {
		...
		async getUserCredentials(
			...
			axios?: AxiosInstance,
			basePath?: string,
		) => AxiosPromise<CredentialsModel>> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUserCredentials(
					username,
					authenticationToken,
		...
		async getUserInfo(
			...
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUserInfo(
					kind,
					authenticationToken,
					authenticationToken2,
					options,
		...
		async getUserSettings(
			...
			axios?: AxiosInstance,
			basePath?: string,
		) => AxiosPromise<UserSettingsModel>> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUserSettings(
					username,
					authenticationToken,
					authenticationToken2,
					options,
		...
		async getUserTheme(
			...
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUserTheme(
					username,
					windowsTheme,
					authenticationToken,
					authenticationToken2,
		...
		async setUserSettings(
			...
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.setUserSettings(
					username,
					authenticationToken,
					authenticationToken2,
					setUserSettingsModel,
