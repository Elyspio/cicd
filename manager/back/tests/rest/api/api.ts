...
export interface BuildAgentModelAdd {
     ...
     * @memberof BuildAgentModelAdd
     */
    ability: Array<BuildAgentModelAddAbilityEnum>;
}
...
export interface BuildAgentModelReturn {
     ...
     * @memberof BuildAgentModelReturn
     */
    ability?: Array<BuildAgentModelReturnAbilityEnum>;
}
...
export const GithubWebhooksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        githubWebhooksPush1: async (githubPushWebhook: GithubPushWebhook, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'githubPushWebhook' is not null or undefined
            assertParamExists('githubWebhooksPush1', 'githubPushWebhook', githubPushWebhook)
            const localVarPath = `/core/github/webhook/push`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const GithubWebhooksApiFp = function (configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async githubWebhooksPush1(githubPushWebhook: GithubPushWebhook, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.githubWebhooksPush1(githubPushWebhook, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const GithubWebhooksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        githubWebhooksPush1(githubPushWebhook: GithubPushWebhook, options?: any): AxiosPromise<void> {
            return localVarFp.githubWebhooksPush1(githubPushWebhook, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GithubWebhooksApi extends BaseAPI {
     ...
     * @memberof GithubWebhooksApi
     */
    public githubWebhooksPush1(githubPushWebhook: GithubPushWebhook, options?: any) {
        return GithubWebhooksApiFp(this.configuration).githubWebhooksPush1(githubPushWebhook, options).then((request) => request(this.axios, this.basePath));
    }
}
